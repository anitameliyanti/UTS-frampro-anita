...
export default function Contact() {
  ...
  return (
    <>
    <div className='text-center'><h1><b>Our Menu's</b></h1>
    <p>- Choco Cupcakes - Rainbow Cupcakes
    - Oreo Cupcakes
    - Turkis Choco Cupcakes
    - Salted Caramel CupCakes
    - Strawberry Cupcakes
    - MixBerries Cupcake</p>
    </div>
      <Container>
        <Row>
        ...
        <Container className="bg-light">
          ...
          <Row>
            ...
            <Col md={6} sm={6}>{pesanan} <b>CupCakes</b></Col>
          </Row>
          <Row>
